...
import { Button, Combobox, TextInput, useCombobox } from '@pradeeparul2/mantine-core';
import { MantineDemo } from '@mantinex/demo';

const code = `
import { useState } from 'react';
import { TextInput, Button, Combobox, useCombobox } from '@pradeeparul2/mantine-core';
